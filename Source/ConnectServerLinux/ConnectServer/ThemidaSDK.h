...
#define CODEREPLACE_START do {} while (0)
#define CODEREPLACE_END do {} while (0)
#define ENCODE_START do {} while (0)
#define ENCODE_END do {} while (0)
#define CLEAR_START do {} while (0)
#define CLEAR_END do {} while (0)
#define VM_START do {} while (0)
#define VM_END do {} while (0)
#define VM_START_WITHLEVEL(x) do { (void)(x); } while (0)
#define UNPROTECTED_START do {} while (0)
#define UNPROTECTED_END do {} while (0)
#define CHECK_PROTECTION(var, val) do { (var) = (val); } while (0)
#define CHECK_CODE_INTEGRITY(var, val) do { (var) = (val); } while (0)
#define CHECK_VIRTUAL_PC(var, val) do { (var) = (val); } while (0)
